    ...
    <div class="container">
        ...
        <div class="form-horizontal col-md-12" role="form">
            <div class="form-group row">
                ...
                <div class="col-sm-1 col-md-4 col-xs6">
                    <asp:Button ID="BuscarButton" runat="server" Text="Buscar" class="btn btn-primary btn-sm" OnClick="BuscarButton_Click" ValidationGroup="Buscar"/>
                </div>
            </div>
            ...
            <div class="panel">
                <div class="text-center">
                    <div class="form-group">
                        ...
                        <asp:Button ID="BtnGuardar" runat="server" Text="Guardar" class="btn btn-success btn-sm" OnClick="BtnGuardar_Click" ValidationGroup="guardar"/>
                        <asp:Button ID="BtnEliminar" runat="server" Text="Eliminar" class="btn btn-danger btn-sm" OnClick="BtnEliminar_Click" ValidationGroup="Buscar"/>
                    </div>
                </div>
            </div>
            <hr>
